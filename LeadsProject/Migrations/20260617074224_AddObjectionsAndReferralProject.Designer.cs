...
namespace LeadsProject.Migrations
{
    ...
    [Migration("20260617074224_AddObjectionsAndReferralProject")]
    partial class AddObjectionsAndReferralProject
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LeadsProject.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "מנהל",
                            PasswordHash = "$2a$11$evRrSPSnqZnwEbUQ0jHmiuM2BDWw8J/ciBtRTUlWqibe3iIAjWVI.",
                            Role = "manager"
                        },
                        new
                        {
