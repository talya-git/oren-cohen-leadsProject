...
namespace LeadsProject.Migrations
{
    ...
    [Migration("20260617090251_AddInterestedInProject")]
    partial class AddInterestedInProject
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LeadsProject.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "מנהל",
                            PasswordHash = "$2a$11$SAsP0G...syawOhiNAM3JeVWL5cvHNuRufa2Ny5ePs4WkAcWQUD9C",
                            Role = "manager"
                        },
                        new
                        {
